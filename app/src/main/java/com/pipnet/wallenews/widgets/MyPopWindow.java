...
public class MyPopWindow implements PopupWindow.OnDismissListener {
    ...
    public static class PopupWindowBuilder {
        ...
        public PopupWindowBuilder(Context context) {
            mMyPopWindow = new MyPopWindow(context);
        }

        public PopupWindowBuilder size(int width, int height) {
            mMyPopWindow.mWidth = width;
            mMyPopWindow.mHeight = height;
            return this;
        }


        public PopupWindowBuilder setFocusable(boolean focusable) {
            mMyPopWindow.mIsFocusable = focusable;
            return this;
        }


        public PopupWindowBuilder setView(int resLayoutId) {
            mMyPopWindow.mResLayoutId = resLayoutId;
            mMyPopWindow.mContentView = null;
            return this;
        }

        public PopupWindowBuilder setView(View view) {
            mMyPopWindow.mContentView = view;
            mMyPopWindow.mResLayoutId = -1;
            return this;
        }

        public PopupWindowBuilder setOutsideTouchable(boolean outsideTouchable) {
            mMyPopWindow.mIsOutside = outsideTouchable;
            return this;
        }
        ...
        public PopupWindowBuilder setAnimationStyle(int animationStyle) {
            mMyPopWindow.mAnimationStyle = animationStyle;
            return this;
        }


        public PopupWindowBuilder setClippingEnable(boolean enable) {
            mMyPopWindow.mClippEnable = enable;
            return this;
        }


        public PopupWindowBuilder setIgnoreCheekPress(boolean ignoreCheekPress) {
            mMyPopWindow.mIgnoreCheekPress = ignoreCheekPress;
            return this;
        }

        public PopupWindowBuilder setInputMethodMode(int mode) {
            mMyPopWindow.mInputMode = mode;
            return this;
        }

        public PopupWindowBuilder setOnDissmissListener(PopupWindow.OnDismissListener onDissmissListener) {
            mMyPopWindow.mOnDismissListener = onDissmissListener;
            return this;
        }


        public PopupWindowBuilder setSoftInputMode(int softInputMode) {
            mMyPopWindow.mSoftInputMode = softInputMode;
            return this;
        }


        public PopupWindowBuilder setTouchable(boolean touchable) {
            mMyPopWindow.mTouchable = touchable;
            return this;
        }

        public PopupWindowBuilder setTouchIntercepter(View.OnTouchListener touchIntercepter) {
            mMyPopWindow.mOnTouchListener = touchIntercepter;
            return this;
        }
        ...
        public PopupWindowBuilder enableBackgroundDark(boolean isDark) {
            mMyPopWindow.mIsBackgroundDark = isDark;
            return this;
        }
        ...
        public PopupWindowBuilder setBgDarkAlpha(float darkValue) {
            mMyPopWindow.mBackgroundDrakValue = darkValue;
            return this;
        }
        ...
        public PopupWindowBuilder enableOutsideTouchableDissmiss(boolean disMiss) {
            mMyPopWindow.enableOutsideTouchDisMiss = disMiss;
            return this;
        }
