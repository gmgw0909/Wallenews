...
public class FollowerActivity extends BaseActivity implements IRefreshPage, BaseQuickAdapter.OnItemClickListener {
    ...
    public void loadData() {
        NetRequest.followerList(cursor, new BaseSubscriber<FollowResponse>() {
            @Override
